...
class ActionsForElements():
    ...
    def IsTheBottomOfScroll(self, roi_bw, scroll_p1, scroll_p2, down_button_p1, down_button_p2):
        pass
        # save start view of scrollbar
        #scroll_before_click = CommonMethods.CropImageByPoints(roi_bw, scroll_p1, scroll_p2)
        #score_before_click = PatternMatching.ComparePixelByPixel(scroll_before_click, scroll_before_click)
        ...
        #score_after_click = PatternMatching.ComparePixelByPixel(scroll_before_click, scroll_after_click)
